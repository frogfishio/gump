...
fixture="$root_dir/fixtures/finite-hello"
...
output="$root_dir/evidence/finite-hello-$capsule_id.capsule"
receipt="$root_dir/evidence/finite-hello-$capsule_id.receipt.json"
build_result="$(GUMP_FIXTURE_GREETING="hello from the live Gump cluster" \
