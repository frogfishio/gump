...
fixture="$root_dir/fixtures/ringtail-relay-probe"
...
output="$root_dir/evidence/ringtail-relay-probe-$capsule_id.capsule"
receipt="$root_dir/evidence/ringtail-relay-probe-$capsule_id.receipt.json"
